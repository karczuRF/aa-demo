...
export interface IAlchemyNonceManagerInterface extends Interface {
...
export interface IAlchemyNonceManager extends BaseContract {
  connect(runner?: ContractRunner | null): IAlchemyNonceManager;
  waitForDeployment(): Promise<this>;

  interface: IAlchemyNonceManagerInterface;
