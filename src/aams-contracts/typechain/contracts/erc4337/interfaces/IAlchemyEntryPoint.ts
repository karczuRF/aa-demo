...
export declare namespace IAlchemyEntryPoint {
...
export interface IAlchemyEntryPointInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addStake"
      | "balanceOf"
  ...
  encodeFunctionData(
    ...
    values: [IAlchemyEntryPoint.UserOpsPerAggregatorStruct[], AddressLike]
  ): string;
  encodeFunctionData(
...
export interface IAlchemyEntryPoint extends BaseContract {
  connect(runner?: ContractRunner | null): IAlchemyEntryPoint;
  waitForDeployment(): Promise<this>;

  interface: IAlchemyEntryPointInterface;
  ...
  handleAggregatedOps: TypedContractMethod<
    [
      opsPerAggregator: IAlchemyEntryPoint.UserOpsPerAggregatorStruct[],
