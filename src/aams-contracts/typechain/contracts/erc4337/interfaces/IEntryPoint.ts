...
export declare namespace IEntryPoint {
  export type UserOpsPerAggregatorStruct = {
    userOps: AlchemyUserOperationStruct[];
    aggregator: AddressLike;
    signature: BytesLike;
  };

  export type UserOpsPerAggregatorStructOutput = [
    userOps: AlchemyUserOperationStructOutput[],
    aggregator: string,
    signature: string
  ] & {
    userOps: AlchemyUserOperationStructOutput[];
...
export interface IEntryPointInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [AlchemyUserOperationStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [AlchemyUserOperationStruct[], AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [AlchemyUserOperationStruct, AddressLike, BytesLike]
  ): string;
  encodeFunctionData(
...
export interface IEntryPoint extends BaseContract {
  ...
  handleOps: TypedContractMethod<
    [ops: AlchemyUserOperationStruct[], beneficiary: AddressLike],
    [void],
    "nonpayable"
  >;
